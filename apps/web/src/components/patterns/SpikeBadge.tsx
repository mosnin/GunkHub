 ...
 */
export function SpikeBadge({ isSpiking, assessed = true, className }: SpikeBadgeProps) {
  if (!assessed) {
    return (
      <span
        className={cn(
  ...
  return (
    <span
      role="status"
      aria-label="This failure pattern is spiking — recent occurrences are well above its baseline rate"
      className={cn(
